...
export default function EmployeePanel({ data: initialData, currentUser }) {
  ...
  const generateRandomIBAN = () => {
    ...
    while (
      ...
      const newRandomDigits = Array.from({ length: 12 }, () =>
        Math.floor(Math.random() * 10)
      ).join("");
...
const highlightText = (text, searchTerm) => {
  ...
  const validateAccountForm = () => {
    ...
    if (selectedPerson && accountFormData.currency !== "EUR") {
      const existingCurrencyAccounts =
        selectedPerson.accounts?.filter(
          (acc) => acc.currency === accountFormData.currency
        ) || [];
  ...
  const handleAccountFormChange = (field, value) => {
    ...
    if (
      field === "servicePlan" &&
      !["Jaunimo", "Standard", "Gold"].includes(value)
    ) {
  ...
  const deleteCrmEntry = (entryId) => {
    ...
    const updatedPerson = {
      ...selectedPerson,
      crmEntries:
        selectedPerson.crmEntries?.filter((entry) => entry.id !== entryId) ||
        [],
    };
        ...
        <div className="client-card-content">
          ...
          <div className="client-info">
            ...
            {person.crmEntries && person.crmEntries.length > 0 ? (
              ...
              <p className="client-preview no-recent-activities">
                  ...
                  {selectedPerson?.regAddress ? (
                    <>
                      <div>
                        <div>
                          Apartment:{" "}
                          {selectedPerson.regAddress.apartment || "N/A"}
                        </div>
                        {selectedPerson.regAddress.street || "N/A"}{" "}
                        {selectedPerson.regAddress.house || "N/A"}
                      </div>
                      <div>
                      ...
                      <div>
                        {selectedPerson.regAddress.region || "N/A"},{" "}
                        {selectedPerson.regAddress.country || "N/A"}
                      </div>
                    </>
                  ) : (
                  ...
                  {selectedPerson?.regAddress ? (
                    <>
                      <div>
                        <div>
                          Apartment:{" "}
                          {selectedPerson.corAddress.apartment || "N/A"}
                        </div>
                        {selectedPerson.corAddress.street || "N/A"}{" "}
                        {selectedPerson.corAddress.house || "N/A"}
                      </div>
                      <div>
                      ...
                      <div>
                        {selectedPerson.corAddress.region || "N/A"},{" "}
                        {selectedPerson.corAddress.country || "N/A"}
                      </div>
                    </>
                  ) : (
                    <div>No address info</div>
              ...
              >
                <div className="crm-entry-header">
                  <div
                    ...
                    onClick={() => toggleCrmExpansion(entry.id)}
                  >
                    {expandedCrmEntries[entry.id] ? (
                      <ChevronDown size={16} />
                    ) : (
    ...
    <div className="employee-panel dashboard-fade-in">
      ...
      {isLogoutOpen && (
        <div
          ...
          onClick={(e) => e.target === e.currentTarget && closeModal("logout")}
        >
          <div
            className={`modal-content logout-modal ${
              modalClosing.logout ? "closing" : ""
            }`}
          ...
          >
            ...
            <div className="modal-body">
              ...
              <div className="form-actions">
                ...
                <button
                  type="button"
                  className="button-primary logout-confirm"
      ...
      {isAddClientOpen && (
        <div
          className="modal-overlay"
          onClick={(e) =>
            e.target === e.currentTarget && closeModal("addClient")
          }
        >
          <div
            className={`modal-content large-modal ${
              modalClosing.addClient ? "closing" : ""
            }`}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="modal-header">
                ...
                <div className="form-group">
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      ...
                      <input
                        className={`form-input ${
                          errors.registrationCountry ? "error" : ""
                        }`}
                    ...
                    <div className="form-group">
                      ...
                      <input
                        className={`form-input ${
                          errors.registrationRegion ? "error" : ""
                        }`}
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      ...
                      <input
                        className={`form-input ${
                          errors.registrationStreet ? "error" : ""
                        }`}
                    ...
                    <div className="form-group">
                      ...
                      <input
                        className={`form-input ${
                          errors.registrationHouse ? "error" : ""
                        }`}
                    ...
                    <div className="form-group">
                      ...
                      <input
                        className={`form-input ${
                          errors.registrationApartment ? "error" : ""
                        }`}
                  ...
                  <div className="form-group">
                    ...
                    <input
                      className={`form-input ${
                        errors.registrationPostalCode ? "error" : ""
                      }`}
                    ...
                    <div className="phone-input-group">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleClientFormChange("secondPhone", e.target.value)
                        }
      ...
      {isAddAccountOpen && (
        <div
          className="modal-overlay"
          onClick={(e) =>
            e.target === e.currentTarget && closeModal("addAccount")
          }
        >
          <div
            className={`modal-content ${
              modalClosing.addAccount ? "closing" : ""
            }`}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="modal-header">
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      disabled={
                        !["Jaunimo", "Standard", "Gold"].includes(
                          accountFormData.servicePlan
                        )
                      }
                    >
                      <option value="none">/</option> {/* no card */}
                      {["Jaunimo", "Standard", "Gold"].includes(
                        accountFormData.servicePlan
                      ) && (
                        <>
      ...
      {isAddCrmOpen && (
        <div
          className="modal-overlay"
          onClick={(e) => e.target === e.currentTarget && closeModal("addCrm")}
        >
          <div
            className={`modal-content ${modalClosing.addCrm ? "closing" : ""}`}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="modal-header">
              <h3 className="modal-title">
              ...
              <form onSubmit={handleAddCrm}>
                ...
                <div className="form-group">
                  ...
                  <div className="character-count">
                    {crmFormData.content.length}/500 characters
                  </div>
                  {errors.content && (
      ...
      {isEditCrmOpen && (
        <div
          className="modal-overlay"
          onClick={(e) => e.target === e.currentTarget && closeModal("editCrm")}
        >
          <div
      ...
      {isDeleteClientOpen && (
        <div
          className="modal-overlay"
          onClick={(e) =>
            e.target === e.currentTarget && closeModal("deleteClient")
          }
        >
          <div
            className={`modal-content ${
              modalClosing.deleteClient ? "closing" : ""
            }`}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="modal-header">
            ...
            <div className="modal-body">
              <p className="delete-warning">
                Are you sure you want to delete {selectedPerson?.firstName}{" "}
                {selectedPerson?.lastName}? This action cannot be undone and
                will remove all associated accounts and CRM data.
              </p>
              <div className="form-actions">
                <button
                  type="button"
