    ...
    <div className="employee-panel">
      ...
      {isLogoutOpen && (
        <div
          ...
          onClick={(e) =>
            e.target === e.currentTarget && closeModal("logout")
          }
        >
          <div
              ...
              <form onSubmit={handleAddClient}>
                ...
                <div className="form-group">
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setSameAsRegistration(e.target.checked)
                      }
                    />
                    ...
                    <>
                      ...
                      <div className="form-grid">
                        <div className="form-group">
                          ...
                          <input
                            className={`form-input ${
                              errors.correspondenceCountry ? "error" : ""
                            }`}
                        ...
                        <div className="form-group">
                          ...
                          <input
                            className={`form-input ${
                              errors.correspondenceRegion ? "error" : ""
                            }`}
                      ...
                      <div className="form-grid">
                        <div className="form-group">
                          ...
                          <input
                            className={`form-input ${
                              errors.correspondenceCity ? "error" : ""
                            }`}
                        ...
                        <div className="form-group">
                          ...
                          <input
                            className={`form-input ${
                              errors.correspondenceStreet ? "error" : ""
                            }`}
                      ...
                      <div className="form-grid">
                        <div className="form-group">
                          ...
                          <input
                            className={`form-input ${
                              errors.correspondenceHouse ? "error" : ""
                            }`}
                        ...
                        <div className="form-group">
                          ...
                          <input
                            className={`form-input ${
                              errors.correspondenceApartment ? "error" : ""
                            }`}
                      ...
                      <div className="form-group">
                        ...
                        <input
                          className={`form-input ${
                            errors.correspondencePostalCode ? "error" : ""
                          }`}
                ...
                <div className="form-checkbox">
                  <input
                    ...
                    onChange={(e) =>
                      handleClientFormChange("marketingConsent", e.target.checked)
                    }
